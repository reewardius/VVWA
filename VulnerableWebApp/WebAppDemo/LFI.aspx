...
<body>
    ...
    <br />
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Button1" ToolTip="Server.Execute(filename)" />
    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Button2" ToolTip=" Response.WriteFile(filename);" />
    <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Button3" ToolTip="File.ReadAllText(filename)" />
             <br />
             <br />
